...
function ContactPage() {
    ...
    const myEmail = (
        <a href="mailto:tanakan@oregonstate.edu" className="email-link">
            tanakan@oregonstate.edu
        </a>
    );
        ...
        <>
            <div className="content-block">
                <div className="content-block-inner">
                    <div className="contact-result page-text center-text">
                        {result}
                    </div>
                </div>
            </div>
                    ...
                    <div className="content-block-inner">
                        ...
                        <div className="content-block-text-container">
                            <p className="content-block-text page-subtitle page-text">
                                Email me at {myEmail} or fill out the form
                                below.
                            </p>
                        </div>
                    </div>
